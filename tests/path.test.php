...
$resolve_source = [
'C:\\xampp\\htdocs\\filesystem\\src\\components\\Button\\index.js\\styles\\main.css\\themes\\dark\\assets\\images\\logos\\logo.png' => Path::resolve('src///components///Button///index.js', 'styles///main.css', 'themes///dark', 'assets///images', 'logos///logo.png'),
'C:\\xampp\\htdocs\\filesystem\\src\\components\\Card\\index.js\\styles\\card.css\\themes\\light\\assets\\images\\icons\\icon.svg' => Path::resolve('src///components///Card///index.js', 'styles///card.css', 'themes///light', 'assets///images', 'icons///icon.svg'),
'C:\\xampp\\htdocs\\filesystem\\src\\utils\\helpers\\dateUtils\\formatDate.js\\validators\\emailValidator.js\\parsers\\csvParser.js\\formatters\\jsonFormatter.js\\constants\\appConstants.js' => Path::resolve('src///utils///helpers///dateUtils///formatDate.js', 'validators///emailValidator.js', 'parsers///csvParser.js', 'formatters///jsonFormatter.js', 'constants///appConstants.js'),
'C:\\xampp\\htdocs\\filesystem\\src\\services\\api\\user\\v1\\index.js\\models\\UserModel.js\\controllers\\UserController.js\\middlewares\\authMiddleware.js\\utils\\apiUtils.js' => Path::resolve('src///services///api///user///v1///index.js', 'models///UserModel.js', 'controllers///UserController.js', 'middlewares///authMiddleware.js', 'utils///apiUtils.js'),
'C:\\xampp\\htdocs\\filesystem\\src\\config\\defaults\\settings\\userSettings.json\\env\\development.env\\env\\production.env\\db\\config.js\\api\\apiConfig.json' => Path::resolve('src///config///defaults///settings///userSettings.json', 'env///development.env', 'env///production.env', 'db///config.js', 'api///apiConfig.json'),
...
'..\\edit\\index.html'=>Path::relative('src///views///user///profile///details', 'src///views///user///profile///edit/index.htmlf'),
